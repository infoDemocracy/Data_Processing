...
ec_data_main <- select(ec_data, dntn_regulated_entity_name, dntn_value, dntn_donor_name, dntn_accounting_unit_name, dntn_is_bequest, dntn_accepted_date, dntn_donor_id)
